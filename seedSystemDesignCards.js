...
const CARDS_DATA = [
  // === 1. System Design Fundamentals ===
  {
    ...
    bullets3: [
      'Pro: Prevents service outages and data loss when load spikes.',
      'Con: Massive operational complexity and higher server maintenance costs.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Scope stays restricted, preventing waste of whiteboard space on auxiliary services.',
      'Con: Under-specifying functional goals leads to complete schema redesign later.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Dictates hardware sizing, caching choices, and database replication patterns.',
      'Con: Extremely hard to retrofit security/availability metrics into an already built monolith.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Improves conversion rates and user engagement.',
      'Con: Optimizing for low latency often increases memory usage (caches) and hardware cost.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Prevents system collapse under massive user spikes.',
      'Con: Higher resource usage and synchronization costs across distributed nodes.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: High user trust and compliance with corporate SLA targets.',
      'Con: Designing for high availability requires active-active setups, doubling hardware budgets.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Zero transaction losses and strong data integrity.',
      'Con: Increases write latency because of disk flushes (commit checks) and consensus overhead.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: System survives massive viral spikes (e.g. flash sales).',
      'Con: Designing for scalability adds distributed routing and complexity overhead.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Maximizes system efficiency by targeting resource upgrades where they matter.',
      'Con: Resolving one bottleneck immediately exposes the next slowest component.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Prevents over-provisioning (saves cash) and under-provisioning (saves crashes).',
      'Con: Estimates are based on assumptions; real-world behavior can vary.'
    ],
    bullets4: [
  ...
  // === 2. Scalability Basics ===
  {
    ...
    bullets3: [
      'Pro: Simplest scaling approach. No complex network synchronization or data inconsistency.',
      'Con: Hard hardware limit (a machine can only have so much RAM/CPU). Single point of failure.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Infinite scale limit. Redundancy is built-in (if one server dies, others take over).',
      'Con: Introduces network latency, complex debugging, and consistency issues across databases.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Dynamic auto-scaling is trivial. Failing nodes can be destroyed and replaced immediately.',
      'Con: Redis database lookup is required for every user validation check, adding latency.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Sub-millisecond local RAM access for session parameters; no external cache calls.',
      'Con: Scaling is hard. If Server Y crashes, all local active session states are lost.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Stops you from wasting money upgrading CPU when the real issue is database disk I/O.',
      'Con: Requires deep logging metrics which can add runtime latency overhead.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Structured decision making. Avoids expensive architecture rewrites.',
      'Con: Requires predicting real-world user traffic patterns, which is never 100% accurate.'
    ],
    bullets4: [
  ...
  // === 3. Load Balancing ===
  {
    ...
    bullets3: [
      'Pro: Enhances availability (failover is seamless) and scalability.',
      'Con: The Load Balancer itself becomes a single point of failure unless clustered (DNS round-robin).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Zero memory overhead. Extremely fast routing decisions.',
      'Con: Does not consider server load. Can send heavy requests to a node that is already CPU-choked.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Active load balancing. Prevents hotspots.',
      'Con: Higher memory overhead at LB level. Not ideal for short HTTP requests (Round Robin is faster).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Minimizes cache misses during scaling events.',
      'Con: Complex implementation and harder lookup calculations than standard modulo (`hash(key) % N`).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Complete auto-healing of traffic routing.',
      'Con: Health checks consume server CPU. If configured too aggressively, they can overload servers.'
    ],
    bullets4: [
  ...
  // === 4. Caching ===
  {
    ...
    bullets3: [
      'Pro: Drastically decreases read latency, protects database from overloading.',
      'Con: Cache data can become stale, adding severe cache invalidation logic overhead.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Immediate response return (sub-10ms), bypassing downstream database query overhead.',
      'Con: None, this is the desired path.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Ensures database remains final source of truth.',
      'Con: Spikes database CPU if multiple misses occur simultaneously (cache stampede).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Cache only contains requested data (conserves RAM). Resilient (if cache dies, DB still works).',
      'Con: Double read penalty on misses. Risk of stale data if DB is updated without deleting cache key.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Cache is never stale. Reads are always fast (never misses if pre-populated).',
      'Con: High write latency (waits for both cache and DB writes to complete). Wastes RAM on rarely read writes.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Extreme write speed (sub-millisecond). Reduces database write load (collapses multiple updates into one).',
      'Con: Risk of data loss. If cache crashes before flushing to database, data is lost forever.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Prevents permanent data staleness. Automatically reclaims cache RAM on inactive keys.',
      'Con: Hard to pick the perfect duration. If too short, DB gets hammered; if too long, users see stale data.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Guarantees users see fresh data quickly.',
      'Con: Hard to implement reliably in distributed clusters due to race conditions.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      ...
      'Con: Single-threaded (heavy command can block the server). Memory size is limited by server RAM.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Strong relational integrity. Declarative language (SQL) simplifies query logic.',
      'Con: Normalization requires database JOIN operations, which slow down at scale.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Flexible schema (add keys anytime). Fast read access since data is self-contained.',
      'Con: Lack of referential integrity (if you delete a user, orphaned posts are left behind unless manually cleaned).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Sub-millisecond reads/writes. Extremely simple interface.',
      'Con: Cannot perform complex queries, sorting, or relational joins natively.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: High compression ratios. Fast aggregates (only reads the specified column files, ignoring other fields).',
      'Con: Writing single rows (INSERT) is slower because multiple column files must be updated.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Converts `O(N)` scans into `O(log N)` index lookups.',
      'Con: Slows down writes (INSERT, UPDATE, DELETE must update the index structure). Consumes disk space.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Prevents financial/accounting data corruption.',
      'Con: Enforcing ACID locks resources, reducing maximum concurrent throughput.'
    ],
    bullets4: [
  ...
  // === 6. Database Scaling ===
  {
    ...
    bullets3: [
      'Pro: survives server node loss. Offloads read queries from the primary server.',
      'Con: Stale reads can occur in asynchronous replication (replication lag).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Simple setup. Offloads reads easily.',
      'Con: Write capacity is limited by a single Master. Failover promotion window can cause brief write downtime.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Industry standard, highly automated failovers.',
      'Con: Handling multi-leader conflicts requires complex resolution algorithms (LWW).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Unlimited database write scaling capacity.',
      'Con: Complex joins are broken. Hard to re-shard when database nodes increase.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Faster queries (partition pruning). Easy data cleanup (drop partition instead of DELETE rows).',
      'Con: Limited to the storage/resource limit of the single database server instance.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: High read scale. Master database is shielded from analytic overhead.',
      'Con: Stale reads can occur due to replication lag.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Prevents service crashes by proactively fixing database load.',
      'Con: Sharding/partitioning requires complex code migrations.'
    ],
    bullets4: [
  ...
  // === 7. CAP Theorem ===
  {
    ...
    bullets3: [
      'Pro: Clear trade-off framework for distributed database choices.',
      'Con: Often oversimplified; real systems support hybrid consistency models.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Simple application logic (reads are always correct).',
      'Con: High write latency (waits for replication check). Reduced availability.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: High system responsiveness. The app never goes down for users.',
      'Con: Users will see stale or conflicting data that must be resolved later.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: System remains resilient to cloud infrastructure failures.',
      'Con: Forces complex tradeoffs on consistency and availability.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Strict data correctness. No sync merge conflicts.',
      'Con: Users see errors or experience connection timeouts during network split.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: High availability, low latency writes.',
      'Con: Temporary inconsistencies. Complex data merge strategies needed.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Demonstrates architectural maturity and trade-off thinking.',
      'Con: None, this is the optimal interview strategy.'
    ],
    bullets4: [
  ...
  // === 8. Consistency Models ===
  {
    ...
    bullets3: [
      'Pro: Absolute data correctness. No stale reads.',
      'Con: Slow writes (must propagate to majority of nodes before returning). Low availability.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Extreme horizontal write scale and low write latency.',
      'Con: Temporary inconsistencies can lead to race conditions in application logic.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Good user experience without requiring global strong consistency.',
      'Con: Increases load on primary master database node.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Strong consistency can be achieved on eventual consistency databases (like Cassandra).',
      'Con: Increased read latency and network overhead (must wait for multiple node responses).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: High reliability. No transaction data loss if one node dies.',
      'Con: High write latency.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Optimizes hardware cost and app speed.',
      'Con: Multi-consistency architectures require careful database choices (polyglot persistence).'
    ],
    bullets4: [
  ...
  // === 9. Messaging Queues ===
  {
    ...
    bullets3: [
      'Pro: Web server responds instantly. Protects workers from crashing during load spikes.',
      'Con: Introduces asynchronous lag (user doesn\'t see result immediately). Harder transaction management.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Smooth work distribution. Auto-scaling is simple.',
      'Con: Requires message validation to prevent poisoned pill messages.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Extreme write scale. Messages can be replayed from any offset.',
      'Con: Massive operational complexity. Partition key selection is critical.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Rich routing logic. Supports transactional messaging and instant acknowledgements.',
      'Con: Not replayable (once message is read and acknowledged, it is gone). Low throughput compared to Kafka.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Services are completely decoupled. High scalability.',
      'Con: Hard to trace request flows across multiple services. Eventual consistency challenges.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Automatically recovers from minor network/service drops.',
      'Con: Retrying non-transient errors (e.g. invalid password) wastes resources and can DDOS your own downstream databases.'
    ],
    bullets4: [
      'Q: "What is Jitter?"',
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Keeps primary queue clear of blockages. Simplifies debugging.',
      'Con: None. Essential safety net for asynchronous systems.'
    ],
    bullets4: [
  ...
  // === 10. Distributed Systems Basics ===
  {
    ...
    bullets3: [
      'Pro: High availability, infinite horizontal scaling.',
      'Con: Extremely complex coordination, network partitions, consistency bugs.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: High system availability and fault tolerance.',
      'Con: Adding redundancy increases system complexity and hardware cost.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Strong consistency. Resilient to node crashes as long as majority is up.',
      'Con: High network overhead (multiple rounds of messages). Latency increases with node count.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Automates high availability failovers.',
      'Con: Risk of split-brain if election split occurs during network partition.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Prevents duplicate job execution and race conditions in distributed systems.',
      'Con: Hard to implement 100% correctly due to GC pauses or clock drifts.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: NTP keeps clocks close (within ms).',
      'Con: Clock drift can cause data loss in systems using Last-Write-Wins (LWW) resolution.'
    ],
    bullets4: [
  ...
  // === 11. Microservices ===
  {
    ...
    bullets3: [
      'Pro: Fast local calling (no network overhead). Simple transactions (ACID is easy on single DB).',
      'Con: Poor scaling (must scale the entire app, not just the bottleneck). Long build and deployment times.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Independent scaling. Tech stack flexibility. Failures are isolated (one service crash doesn\'t kill the app).',
      'Con: High operational complexity. Distributed transaction challenges (requires Saga pattern).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Facilitates seamless horizontal auto-scaling without hardcoding IP addresses.',
      'Con: Introduces an additional infrastructure component that must be kept highly available.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Simplifies client code (one endpoint). Centralized security and rate limiting enforcement.',
      'Con: Gateway becomes a single point of failure and bottleneck if not scaled properly.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Dynamic coordination.',
      'Con: Synchronous communication creates tight runtime coupling.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    topic: 'System Design',
    difficulty: 'Easy',
    folderId: '81d530e3-d883-5ee2-a8d9-6c4e6435f144', // Wait, map to microservices folder
    folderId: '81d530e3-d883-5ee2-a8d9-6c4e6435f154',
    type: 'theory',
    bullets1: [
    ...
    bullets3: [
      'Pro: Fits large organizations (different teams own different services).',
      'Con: Zero benefit for small startups.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Unlocks extreme organizational scale.',
      'Con: Debugging is difficult. Tracing requests requires correlation IDs and APM tools.'
    ],
    bullets4: [
  ...
  // === 12. API Design ===
  {
    ...
    bullets3: [
      'Pro: Human-readable, simple to debug, native browser caching support.',
      'Con: Payload bloat (JSON sends heavy key strings). Over-fetching/under-fetching data.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Clean self-documenting API structure.',
      'Con: None, standard design convention.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Prevents duplicate charges and actions on network drops/retries.',
      'Con: Requires server to maintain a deduplication cache (e.g. Redis tracking keys).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Lowers database load and network transmission payload size.',
      'Con: Offset-based pagination gets progressively slower as page depth increases.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Safe deployments without breaking legacy mobile installations.',
      'Con: Maintaining multiple API versions splits codebase logic and increases support overhead.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Protects servers from DDoS, brute force attacks, and noisy neighbor API consumers.',
      'Con: Adds latency to every request checks (requires fast cache lookup).'
    ],
    bullets4: [
  ...
  // === 13. Storage Systems ===
  {
    ...
    bullets3: [
      'Pro: Extremely cheap storage. High durability (99.999999999% replication). Scales infinitely.',
      'Con: No database query features; you retrieve files only by URL paths.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Scales to billions of files easily. Simple HTTP REST API interface.',
      'Con: Not suited for transactional filesystem operations (no partial updates to files; you must re-upload the whole file).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Simple folder organization. Supports lock synchronization and random file updates.',
      'Con: Scalability limit (folders get slow when holding millions of files). Network mount overhead.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Extreme performance. Low-latency random reads/writes. Supports databases.',
      'Con: Expensive. Can only be mounted to a single server instance at a time.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: High aggregate bandwidth. Survives multiple machine failures.',
      'Con: Operational complexity. Consistent metadata synchronization across cluster.'
    ],
    bullets4: [
  ...
  // === 14. Search Systems ===
  {
    ...
    bullets3: [
      'Pro: Returns search results in milliseconds.',
      'Con: Indexes consume RAM and must be kept in sync with primary databases.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets1: [
      ...
      'Example: "Index" -> [Doc 1, Doc 3]; "Search" -> [Doc 2, Doc 3].',
    ...
    bullets3: [
      'Pro: Constant time `O(1)` query lookup to find matching documents.',
      'Con: Index rebuilds are slow; not ideal for write-heavy update logs.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Excellent search UX and accuracy.',
      'Con: High memory usage to store the massive inverted index in RAM.'
    ],
    bullets4: [
      'Q: "What is BM25?"',
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Scalable, highly performant, rich query DSL.',
      'Con: Expensive RAM requirements. Weak transactional support (not ACID compliant).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Significantly improves click-through rates.',
      'Con: Tuning ranking algorithms requires constant A/B testing.'
    ],
    bullets4: [
      'Q: "What is TF-IDF?"',
  ...
  // === 15. CDN ===
  {
    ...
    bullets3: [
      'Pro: Decreases page load times. Saves server bandwidth.',
      'Con: Cache invalidation delay (users see old assets when update is deployed unless cache-busted).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Minimal latency (physical distance to user is short). Reduces load on main server.',
      'Con: None, standard edge caching architecture.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Optimizes storage and origin bandwidth.',
      'Con: Pull model has latency penalty for the first user requesting the file.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets4: [
      'Pro: Origin server remains idle for 99% of requests.',
      'Con: Misses add latency to first user request.'
    ],
    bullets5: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Drastically improves global app loading times.',
      'Con: None, standard practice.'
    ],
    bullets4: [
  ...
  // === 16. Rate Limiting ===
  {
    ...
    bullets3: [
      'Pro: Protects server resources and database stability.',
      'Con: Adds latency to every request checks (requires fast cache lookup).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Memory efficient (only stores two fields: token count and last refill timestamp). Handles traffic bursts smoothly.',
      'Con: Tuning capacity and refill rate for different API endpoints is difficult.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Guarantees constant, predictable load on downstream databases.',
      'Con: Slows down client requests during spikes because they are forced to wait in the queue.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Extremely simple to implement. Low memory overhead.',
      'Con: Boundary spike (a user can double-spend their limit by sending requests right at the boundary transition).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Perfect accuracy. No boundary spikes.',
      'Con: High memory usage (must store timestamps of *every* request for *every* active user).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Optimizes rate limiter memory usage.',
      'Con: None, standard trade-off check.'
    ],
    bullets4: [
  ...
  // === 17. Real-Time Systems ===
  {
    ...
    bullets3: [
      'Pro: Simple to implement. Works on all web servers and browsers.',
      'Con: Massive resource waste (creates/destroys HTTP connections continually for empty responses). Not real-time.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Real-time responses. Fewer connection handshakes than standard polling.',
      'Con: Thread consumption (holding connections open locks server threads unless using async event-driven loop).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Lightweight. Built-in reconnection support. Uses standard HTTP protocol.',
      'Con: Unidirectional (client cannot send data back over same connection; must make separate POST requests).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Bidirectional low latency. Low frame header overhead after handshake.',
      'Con: Requires stateful WebSocket gateway servers (makes horizontal scaling and load balancing complex).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Instant messaging and high user engagement.',
      'Con: High infrastructure cost. Must manage connection states.'
    ],
    bullets4: [
  ...
  // === 18. Reliability & Fault Tolerance ===
  {
    ...
    bullets3: [
      'Pro: Protects against hardware node deaths and data loss.',
      'Con: Doubles infrastructure costs.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: High availability, zero manual intervention required.',
      'Con: Hard to implement split-brain protection (preventing two master nodes).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: High durability. Read offloading.',
      'Con: Complex synchronization code.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Guarantees business survival after major disaster events.',
      'Con: Requires constant drills and simulation testing.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Reliable service delivery for users.',
      'Con: Extremely high deployment costs due to duplicate active infrastructure.'
    ],
    bullets4: [
  ...
  // === 19. Observability ===
  {
    ...
    bullets3: [
      'Pro: Indispensable for debugging logic bugs.',
      'Con: Writing logs consumes local disk I/O and network bandwidth if pushed to central servers.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Lightweight (only stores numbers). Enables automated dashboard graphing and alert triggers.',
      'Con: None, standard operational requirement.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Fast detection of system outages before users report them.',
      'Con: Dashboard fatigue (setting too many alerts, leading developers to ignore them).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Pinpoints exactly which microservice is adding latency to a request path.',
      'Con: Adds network header overhead and processing log latency.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Automates incident response loops.',
      'Con: Poorly tuned rules lead to developers ignoring critical alerts.'
    ],
    bullets4: [
  ...
  // === 20. Security Basics ===
  {
    ...
    bullets3: [
      'Pro: Restricts system access to verified identities.',
      'Con: Implementing multi-factor auth adds friction to user signup flows.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Protects sensitive admin features from unauthorized access.',
      'Con: Enforcing granular authorization checks adds latency to database lookup queries.'
    ],
    bullets4: [
      'Q: "What is ABAC?"',
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Stateless (scales easily). Web servers do not need to hit database/cache to validate user sessions.',
      'Con: Cannot be easily revoked before expiration (unless blacklist cache is kept, defeating statelessness).'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: User never shares password with third-party app. Simple integration.',
      'Con: Complex token validation and redirect logic.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Protects sensitive user data from physical hardware thefts and hacker snooping.',
      'Con: Encryption adds CPU overhead to database writes.'
    ],
    bullets4: [
  ...
  },
  {
    ...
    bullets3: [
      'Pro: Complete traffic encryption. Browser trust.',
      'Con: SSL handshakes add round-trip latency to the first connection.'
    ],
    bullets4: [
